...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-navy-950 px-4 py-12">
      ...
      <Link
        href="/"
        className="absolute z-10 flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3.5 py-2 text-sm text-mist-200 backdrop-blur-xl transition-colors hover:bg-white/10 hover:text-white"
