...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, error, ...props }, ref) => {
    return (
      <textarea
        className={cn(
          "flex min-h-24 w-full rounded-xl border bg-white px-3.5 py-2.5 text-sm text-graphite-900 shadow-xs transition-all duration-200 placeholder:text-graphite-300",
